...
//                        if(pointY >1800) pointY = 1800F
        ...
        while (!isPointArrayFull) {
            if (isPointArrayFull == true) {
                ...
                Log.d("이미지","0: "  + imageArrayList.size.toString())
...
//                    Log.d("이미지","1: "  + imageArrayList.size.toString())
//                    // SOF~EOI합치기
//                    insertFrameToJpeg()
//                }
//
...
//                .commit()
    ...
    // viewFinder에 있는 화면을 파일로 저장하는 함수
